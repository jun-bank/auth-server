package com.jun_bank.auth_server.global.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* com.jun_bank.auth_server.domain..presentation..*Controller.*(..))")
     ...
     */
    @Pointcut("execution(* com.jun_bank.auth_server.domain..application.service..*Service.*(..))")
